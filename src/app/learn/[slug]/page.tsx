...
const SIDEBAR: SidebarGroup[] = [
  {
    ...
    entries: [
      ...
      { label: "Typography Prompting", slug: "typography-prompting" },
      { label: "Styling Prompting", slug: "styling-prompting" },
      { label: "Animation Prompting", slug: "animation-prompting" },
      { label: "Layout Prompting", slug: "layout-prompting" },
    ],
  },
  {
    title: "VIDEOS",
    entries: [
      ...
      { label: "AI Landing Pages with Media", isVideo: true, hash: "gpt-image-2-gpt-55-landing-page" },
      ...
      { label: "Gemini 3 Changes Everything", isVideo: true, hash: "gemini-3-changes-everything" },
